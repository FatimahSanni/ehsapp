...
class ConsultantsControllerTest < ActionController::TestCase
  ...
  test "should create consultant" do
    assert_difference('Consultant.count') do
      post :create, consultant: { clinic_id: @consultant.clinic_id, consultant_category_id: @consultant.consultant_category_id, name: @consultant.name }
    end
  ...
  test "should update consultant" do
    patch :update, id: @consultant, consultant: { clinic_id: @consultant.clinic_id, consultant_category_id: @consultant.consultant_category_id, name: @consultant.name }
    assert_redirected_to consultant_path(assigns(:consultant))
  end

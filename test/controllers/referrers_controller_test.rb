...
class ReferrersControllerTest < ActionController::TestCase
  ...
  test "should create referrer" do
    assert_difference('Referrer.count') do
      post :create, referrer: { address: @referrer.address, email: @referrer.email, name: @referrer.name, phone: @referrer.phone }
    end
  ...
  test "should update referrer" do
    patch :update, id: @referrer, referrer: { address: @referrer.address, email: @referrer.email, name: @referrer.name, phone: @referrer.phone }
    assert_redirected_to referrer_path(assigns(:referrer))
  end

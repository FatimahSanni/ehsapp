...
class FileRecordsControllerTest < ActionController::TestCase
  ...
  test "should create file_record" do
    assert_difference('FileRecord.count') do
      post :create, file_record: { borrower: @file_record.borrower, patient_id: @file_record.patient_id, reason: @file_record.reason }
    end
  ...
  test "should update file_record" do
    patch :update, id: @file_record, file_record: { borrower: @file_record.borrower, patient_id: @file_record.patient_id, reason: @file_record.reason }
    assert_redirected_to file_record_path(assigns(:file_record))
  end
